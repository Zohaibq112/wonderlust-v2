...
pipeline {
    ...
    stages {
        ...
        stage('Git: Code Checkout') {
            steps {
                script {
                    code_checkout("https://github.com/Zohaibq112/wonderlust-v2-v2.git","main")
                }
            }
        }
                ...
                script {
                    withCredentials([gitUsernamePassword(credentialsId: 'Github-cred', gitToolName: 'Default')]) {
                        sh '''
                            ...
                            git push https://github.com/Zohaibq112/wonderlust-v2-v2.git HEAD:main || echo "Nothing new to push"
                        '''
                    }
                }
            }
